...
import com.biogin.myapplication.databinding.FragmentLogsBinding
...
//        }
        ...
        var listaRegistros = Json.decodeFromString<List<Log>>(registrosString)

        var tablaRegistros = root.findViewById<TableLayout>(R.id.tablaRegistros)
