...
def encode_known_faces(
    ...
    names and encodings, excluding known faces.
    """
    names = []
    encodings = []
    ...
    for filepath in Path("training").glob("*/*"):
        ...
        # Skip known faces
        if name in known_encodings["names"]:
            continue
    ...
    # Update known encodings with newly encoded faces
    known_encodings["names"].extend(names)
    known_encodings["encodings"].extend(encodings)
